...
def nnSizeCrop(image, wSize, bboxCenter):
    ...
    :param wSize: size of the cropping window
    :param bboxCenter: center of the bb
    :return: wSize crop of image centered around bboxCenter, potentiall black padded
    """
    xc, yc = bboxCenter
...
def cropNegative(frame, nnSize, bboxCenter):
    """
    Randomly crops an image with a nnSize window. The resulting crop has no intersection with the bb formed by nnSize and bboxCenter.
    :param frame: input image
    :param nnSize: size of the cropping window
    :param bboxCenter: center of the bb
    :return: image crop
    """
