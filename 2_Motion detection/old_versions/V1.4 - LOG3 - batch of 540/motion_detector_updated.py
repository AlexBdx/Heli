...
for gaussWindow in range(5, 8, 2):# 2
	for mgp in range (75, 126, 25):# 3
		for minArea in [x**2 for x in range(1, 6)]:# 5
			for diffMethod in range(0, 1): # 1
				for winSize in range(3, 14, 2): # 6
...
for simulation in tqdm.tqdm(iterations):
	...
	simOutput = list(simulation)+list(KPIs)
